PImage cimg;
//by Ethan and Swayam using ChatGPT for every function coded aswell as understanding code
...
// Four buttons: Add Cards, Find Set, New Game, Test Deck, Pause
...
public final String keyOptions = "q, w, e, r, [t, y, u]: top row;\na, s, d, f, [g, h, j]: second row;\n" +
                                 ...
                                 "+ to add cards, - to find a set, / for test cards, SPACE to pause, ENTER/RETURN for a new game";
...
public void newTestGame() {
  ...
  for (int i = 0; i < currentCols*ROWS; i++) {
    grid.addCardToBoard(deck.dealFromTop());
  }
...
public void initSpriteSheet() {
  ...
  String imageFile = "set-cards.jpg";
